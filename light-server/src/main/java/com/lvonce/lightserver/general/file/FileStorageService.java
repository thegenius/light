...
public class FileStorageService {
    ...
    @Autowired
    public FileStorageService(FileServiceProperties fileServiceProperties) throws IOException{
        this.fileStorageLocation = Paths.get(fileServiceProperties.getUploadDir())
